...
class ProfessorModal extends StatefulWidget {
  const ProfessorModal({super.key});

  @override
  State<ProfessorModal> createState() => _ProfessorModalState();
}

class _ProfessorModalState extends State<ProfessorModal> {
